                    ...
                    <div class="row col-md-4">
                        <table class="table table-stripped table-condensed">
                            ...
                            <tr>
                                ...
                                <td>  <select id="coa_size" name="coa_size" class="form-control select select2" style="width:auto;" selected="selected" >
                            ...
                            <tr>
                                ...
                                <td>  <select id="coa_size_rsize" name="coa_size_rsize" class="form-control select select2" style="width:auto;" selected="selected" >
								<option value="76">76%</option>
                                        <option value="71">71%</option>
                                        <option value="72">72%</option>
                                        <option value="73">73%</option>
