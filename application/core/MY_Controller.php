...
class MY_Controller extends CI_Controller {
    ...
    public function approveSample($labref) {
            $query="SELECT r.request_id, r.product_name,r.CAN, t.date_added
FROM tracking_table t LEFT JOIN request r ON t.labref = r.request_id
WHERE t.activity='Authorization of COA Release' AND r.request_id IS NOT NULL GROUP BY t.labref;";
	...
	//Get all commented columns from the db
    ...
    function readWorkbookMa($labref) {
        ...
        for ($i = 0; $i <= $number - 1; $i++) {
            ...
            $assay_array = array(
                ...
                'average' => $objWorksheet->getCell('C139')->getCalculatedValue() ,
                'rsd' => $objWorksheet->getCell('C140')->getCalculatedValue() ,
    ...
    function readWorkbookBe($labref) {
        ...
        for ($i = 0; $i <= $number - 1; $i++) {
            ...
            $assay_array = array(
                'test_id' => 50,
                'component' => $objWorksheet->getCell('B16')->getValue(),
                'average' => $objWorksheet->getCell('D68')->getCalculatedValue() ,
                'rsd' => 'NA',
                'n' => 'NA',
                'labref' => $labref
            );
        ...
        for ($i = 1; $i <= $number - 1; $i++) {
            ...
            if (empty($value)) {
                ...
                $assay_array = array(
                    ...
                    'average' => $objWorksheet->getCell('F115')->getOldCalculatedValue() ,
                    'rsd' => $objWorksheet->getCell('F116')->getOldCalculatedValue() ,
                ...
                $assay_array = array(
                    'test_id' => 2,
                    'component' => $this->remove_3($sheet_name),
                    'average' => $objWorksheet->getCell('B159')->getOldCalculatedValue() ,
                    'rsd' => $objWorksheet->getCell('B160')->getOldCalculatedValue() ,
            ...
            $diss_array = array(
                'test_id' => 5,
                'component' => $this->remove_3($sheet_name),
                'average' => $objWorksheet->getCell('H72')->getOldCalculatedValue() ,
                'rsd' => $objWorksheet->getCell('H73')->getOldCalculatedValue() ,
    ...
    function readWorkbook_inj($labref) {
        ...
        for ($i = 1; $i <= $number - 1; $i++) {
            ...
            $diss_array = array(
                'test_id' => 5,
                'component' => $this->remove_3($sheet_name),
                'average' => $objWorksheet->getCell('H71')->getOldCalculatedValue() ,
                'rsd' => $objWorksheet->getCell('H72')->getOldCalculatedValue() ,
    ...
    function setDoneIdSupervisor($labref) {
     ...
     if (!empty($value) && (int) $value == 49) {
                $assay_array = array(
                    ...
                    'supervisor_id' => $supervisor_id,
                    'average' => $objWorksheet->getCell('C141')->getCalculatedValue() ,
           ...
           $sheet_name = $objWorksheet->getTitle();
            ...
            if (!empty($value) && (int) $value == 1) {
                ...
                $assay_array = array(
                    ...
                    'component' => $sheet_name,
                    'test_id' => $test_id = '5',
                    'average' => $Average = $objWorksheet->getCell('H72')->getOldCalculatedValue() ,
                ...
                $diss_array = array(
                    ...
                    'test_id' => '2',
                    'average' => $Average = $objWorksheet->getCell('F118')->getOldCalculatedValue() ,
                ...
                $diss_array2 = array(
                    ...
                    'component' => $sheet_name,
                    'test_id' => '2',
                    'average' => $Average = $objWorksheet->getCell('F135')->getOldCalculatedValue(),
                ...
                $assay_array = array(
                    ...
                    'supervisor_id' => $supervisor_id,
                    'component' => $sheet_name,
                    'average' => $objWorksheet->getCell('H75')->getOldCalculatedValue() ,
                ...
                $assay_array = array(
                    ...
                    'component' => $sheet_name,
                    'medium_day' => 'Day 1',
                    'average' => $objWorksheet->getCell('H73')->getOldCalculatedValue() ,
                ...
                $assay_array1 = array(
                    ...
                    'supervisor_id' => $supervisor_id,
                    'component' => $sheet_name,
                    'average' => $objWorksheet->getCell('H127')->getOldCalculatedValue() ,
                ...
                $diss_array = array(
                    ...
                    'component' => $sheet_name,
                    'supervisor_id' => $supervisor_id,
                    'average' => $objWorksheet->getCell('B165')->getOldCalculatedValue() ,
                ...
                $diss_array = array(
                    ...
                    'rsd' => $objWorksheet->getCell('G71')->getOldCalculatedValue() * 1000,
                ...
                $assay_array = array(
                    ...
                    'supervisor_id' => $supervisor_id,
                    'average' => $objWorksheet->getCell('C141')->getCalculatedValue() ,
                    'rsd' => $objWorksheet->getCell('C142')->getCalculatedValue() * 100,
                    'n' => '',
                    'labref' => $labref
                );
                $this->db->insert('component_summary', $assay_array);
                ...
                $diss_array = array(
                    ...
                    'medium_day' => 'Stage 1',
                    'test_id' => '2',
                    'average' => $Average = $objWorksheet->getCell('F116')->getOldCalculatedValue() ,
                ...
                $diss_array2 = array(
                    ...
                    'component' => $sheet_name,
                    'test_id' => '2',
                    'average' => $Average = $objWorksheet->getCell('F133')->getOldCalculatedValue() ,
        ...
        for ($i = 1; $i <= $number - 1; $i++) {
            ...
            if (empty($value)) {
                ...
                $assay_array = array(
                    'test_id' => 2,
                    'component' => $this->remove_3($sheet_name),
                    'average' => $objWorksheet->getCell('F112')->getOldCalculatedValue() ,
                    'rsd' => $objWorksheet->getCell('F113')->getOldCalculatedValue() ,
...
GROUP BY DATE_FORMAT(designation_date, '%Y%m')");
    ...
    function Returning_to_Supervisor($labref) {
        $activity = 'Transmitting to Supervisor';
        $from = $this->User();
        $to = $this->Supervisor();
        $this->trackingData($labref, $activity, $from, $to);
    }
	
	function getUser($labref){
		$id = $this->db->where('lab_ref_no',$labref)->get('sample_issuance')->result();
		$user = $this->db->where('id',$id[0]->analyst_id)->get('user')->result();
		return $user[0]->fname." ".$user[0]->lname;	
	}
	
	
	 function Received_by_Supervisor($labref) {
        $activity = 'Received by Supervisor';
        $from = $this->getUser($labref);
        $to = $this->User();
        $this->trackingData($labref, $activity, $from, $to);
    }
